...
--
-- Host: 127.0.0.1
-- Generation Time: 18-Jan-2016 às 09:53
-- Versão do servidor: 5.7.9-log
-- PHP Version: 5.6.14
...
-- Database: `gamu`
--
CREATE DATABASE IF NOT EXISTS `gamu` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `gamu`;
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_removeAtuacao` (IN `atuacao` VARCHAR(50))  BEGIN
	DELETE FROM atuacao_aluno
	WHERE atuacao_id = atuacao;
		
	DELETE FROM atuacao_professor
	WHERE atuacao_id = atuacao;
		
	DELETE FROM atuacao_obra
	WHERE atuacao_id = atuacao;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_removeAudicao` (IN `audicao` VARCHAR(50))  BEGIN
	DELETE FROM atuacao_aluno
    	WHERE atuacao_id IN (
        	SELECT atuacao_id FROM atuacao
            	WHERE atuacao_audicao = audicao
        );
...
('A1', 'Eusébio Da Silva Ferreira', '2001-09-13', 'CS7', 2, 'I7'),
...
INSERT INTO `atuacao` (`atuacao_id`, `atuacao_designacao`, `atuacao_audicao`) VALUES
('Atu20', 'Poesia', 'Aud6'),
('Atu21', 'Amor', 'Aud6'),
('Atu22', 'Distorção', 'Aud6');
...
CREATE TABLE `atuacao_aluno` (
  `atuacao_id` varchar(50) CHARACTER SET utf8 NOT NULL,
  `aluno_id` varchar(50) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `atuacao_aluno`
--

INSERT INTO `atuacao_aluno` (`atuacao_id`, `aluno_id`) VALUES
('Atu21', 'A12753'),
('Atu21', 'A16409'),
('Atu21', 'A18938'),
('Atu20', 'A26737'),
...
CREATE TABLE `atuacao_obra` (
  `atuacao_id` varchar(50) CHARACTER SET utf8 NOT NULL,
  `obra_id` varchar(50) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `atuacao_obra`
--

INSERT INTO `atuacao_obra` (`atuacao_id`, `obra_id`) VALUES
('Atu20', 'O171'),
('Atu20', 'O20'),
('Atu20', 'O31'),
('Atu22', 'O62'),
...
CREATE TABLE `atuacao_professor` (
  `atuacao_id` varchar(50) CHARACTER SET utf8 NOT NULL,
  `professor_id` varchar(50) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `atuacao_professor`
--

INSERT INTO `atuacao_professor` (`atuacao_id`, `professor_id`) VALUES
('Atu20', 'P10'),
('Atu20', 'P17'),
('Atu20', 'P2'),
('Atu21', 'P36'),
...
--
-- Extraindo dados da tabela `audicao`
--

INSERT INTO `audicao` (`audicao_id`, `audicao_titulo`, `audicao_subtitulo`, `audicao_tema`, `audicao_data`, `audicao_hora`, `audicao_local`, `audicao_responsavel`, `audicao_duracao`) VALUES
('Aud6', 'A Boémia', 'Concerto de Carnaval', 'Carnaval', '2016-02-07', '21:30', 'Auditório2', 'P21', '2:00:00');
...
ALTER TABLE `aluno`
  ...
  ADD KEY `aluno_instrumento` (`aluno_instrumento`),
  ADD KEY `alunos_curso` (`aluno_curso`);

--
-- Indexes for table `atuacao`
--
ALTER TABLE `atuacao`
  ADD PRIMARY KEY (`atuacao_id`),
  ADD KEY `atuacao_audicao` (`atuacao_audicao`);

--
-- Indexes for table `atuacao_aluno`
--
ALTER TABLE `atuacao_aluno`
  ADD PRIMARY KEY (`atuacao_id`,`aluno_id`),
  ADD KEY `aluno_id` (`aluno_id`);

--
-- Indexes for table `atuacao_obra`
--
ALTER TABLE `atuacao_obra`
  ADD PRIMARY KEY (`atuacao_id`,`obra_id`),
  ADD KEY `obra_id` (`obra_id`);

--
-- Indexes for table `atuacao_professor`
--
ALTER TABLE `atuacao_professor`
  ADD PRIMARY KEY (`atuacao_id`,`professor_id`),
  ADD KEY `professor_id` (`professor_id`);

--
-- Indexes for table `audicao`
--
ALTER TABLE `audicao`
  ADD PRIMARY KEY (`audicao_id`),
  ADD KEY `audicao_responsavel` (`audicao_responsavel`);

--
-- Indexes for table `compositor`
--
ALTER TABLE `compositor`
  ADD PRIMARY KEY (`compositor_id`),
  ADD KEY `compositor_periodo` (`compositor_periodo`);
...
ALTER TABLE `curso`
  ...
  ADD KEY `curso_instrumento` (`curso_instrumento`);

--
-- Indexes for table `habilitacao`
--
ALTER TABLE `habilitacao`
  ADD PRIMARY KEY (`habilitacao_id`);
...
ALTER TABLE `obra`
  ...
  ADD KEY `obra_periodo` (`obra_periodo`),
  ADD KEY `obra_compositor` (`obra_compositor`);
...
ALTER TABLE `professor`
  ...
  ADD KEY `professor_curso` (`professor_curso`),
  ADD KEY `professor_habilitacao` (`professor_habilitacao`);
